...
export function decodeEnvelope(data) {
  ...
  if (typeof obj.id !== 'string' || obj.id.length === 0) throw new Error('Invalid envelope: missing id')
  if (typeof obj.type !== 'string' || obj.type.length === 0) throw new Error('Invalid envelope: missing type')
